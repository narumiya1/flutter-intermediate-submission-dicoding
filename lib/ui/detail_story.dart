...
import 'package:submission_intermediate/provider/detail_p.dart';
import 'package:submission_intermediate/widgets/card_detail.dart';
            ...
            builder: (context, provider, _) {
              switch (provider.state) {
                ...
                case ResultState.hasData:
                  return CardDetail(story: provider.story);
